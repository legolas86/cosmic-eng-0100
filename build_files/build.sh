...
dnf5 -y install ublue-os-libvirt-workarounds libcap proton-vpn-gnome-desktop tmux code bootc wireshark podmansh tcpdump podman-machine podman-compose podman-tui virt-v2v tiptop qemu-kvm libvirt virt-install virt-manager toolbox distrobox flatpak tmux rust cargo rustup golang helix bat zoxide fzf tldr btop ripgrep rust rustup cargo fish
